...
class Utilisateurs extends \UtilisateursBundle\Entity\Utilisateurs implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'commandes', '' . "\0" . 'UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'adresses', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
