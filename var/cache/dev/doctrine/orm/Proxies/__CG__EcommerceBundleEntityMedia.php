 ...
 */
class Media extends \EcommerceBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EcommerceBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'EcommerceBundle\\Entity\\Media' . "\0" . 'path', '' . "\0" . 'EcommerceBundle\\Entity\\Media' . "\0" . 'alt'];
        }
